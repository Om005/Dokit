...
<body>
  ...
  `;
    ...
    getWelcomeEmail: (firstName, lastName) => {
        return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  `;
    ...
    gotAccessRequestEmail: (requesterName, projectName, projectId) => {
        return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="button-container">
        <a href="${env_1.default.FRONTEND_URL}/project/${projectId}" class="btn">Review Access Request</a>
      </div>
  ...
  `;
    ...
    reviewedAccessRequestEmail: (requesterName, projectName, status, projectId) => {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="button-container">
        <a href="${env_1.default.FRONTEND_URL}/project/${projectId.replaceAll(" ", "-")}" class="btn">Go to Project</a>
      </div>`
  ...
  `;
    ...
    projectInvitationEmail: (inviterName, projectName, projectId) => {
        return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="button-container">
        <a href="${env_1.default.FRONTEND_URL}/project/${projectId.replaceAll(" ", "-")}" class="btn">View Project</a>
      </div>
  ...
  `;
    ...
    signinEmail: (session, frontEndUrl) => {
        return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
