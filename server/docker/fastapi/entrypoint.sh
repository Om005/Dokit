...
echo "Syncing FastAPI project: ${PROJECT_ID}"
...
export PATH="/home/dokituser/.local/bin:/workspace/.venv/bin:/workspace/node_modules/.bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
alias ll='ls -alF'
...
echo ""
echo "    1. poetry install (if not done yet)"
echo "    2. poetry run task dev"
echo "  ──────────────────────────────────"
echo ""
